                ...
                <Content>
                    <Tabs>
                        <TabsHeader>
                            ...
                            <TabHeader label='Listar' icon='pencil' target= 'tabUpdate'/>
...
const mapDispachToProps = dispatch => bindActionCreators({selectTab, showTabs}, dispatch)
export default connect(null, mapDispachToProps)(BillingCycle)
